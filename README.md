...
| ---------------------------- | ------------------------------------- | ----------------- |
| [Codify](https://github.com/frank-mck/productivity-app-ts) | A full stack productivity app that helps users organise their tasks to become more efficient.(on going solo project built with love) | TypeScript, React, Node.js, Express, MongoDB |
